      ...
      <div className="flex justify-center w-1/6">
        <ul className="timeline timeline-vertical ">
          <li>
            ...
            <div className="timeline-end timeline-box border-0 p-2 lg:flex items-center lg:mb-28 lg:mt-28 w-max bg-mgray mb-28 mt-[25rem]">
              ...
              <div className=" lg:block hidden ml-10 ">
                ...
                <div className="flex flex-wrap gap-x-1.5 gap-y-1 items-center mt-3 text-sm w-3/5">
